...
<!--
function openwin(){
	window.open(re-pop-up.jsp,,width=200,height=200)
}
//-->
</script>
...
<div class="login">
    ...
    <div class="login_form">
        <span>User name：</span>
        <input type="text" placeholder="Please create a user name">
        <br>
        <span>E-mail：</span>
        <input type="text" placeholder="Please enter you email">
        <br>
        <span>Passport：</span>
        <input type="password" placeholder="Please create your PIN">
        <br>

    </div>

    <div class="btn">
        <button class="register" onclick="window.location.href='login.jsp';register()">register</button>
